...
function data()
return {
	detailTex = tu.makeTextureMipmapRepeat("ground_texture/industry_soil_01_albedo.dds", true, true),
	detailNrmlTex = tu.makeTextureMipmapRepeat("ground_texture/industry_soil_01_normal.dds", true, true, true),
